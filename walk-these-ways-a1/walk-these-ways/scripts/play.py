...
def load_env(label, headless=False, args=None):
    ...
    Cfg.asset.file='{MINI_GYM_ROOT_DIR}/resources/robots/a1/urdf/a1.urdf'
    ...
    Cfg.terrain.terrain_length = 20
    Cfg.terrain.terrain_width = 20
...
def play_a1(headless=True):
    ...
    save_logger.save_buffer("a1_wtw_tacitWeight"+str(args.tacit_weight))
