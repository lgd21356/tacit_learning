...
class StateEstimator:
    def __init__(self, lc, use_cameras=False):
        ...
        self.ori_contact_state = np.ones(4)
        ...
        # self.optitrack_subscription = self.lc.subscribe("optitrack_channel", self._optitrack_cb)
    ...
    def get_ori_contact_state(self):
        return self.ori_contact_state[self.contact_idxs]

    # def get_auto_yaw_command(self):
    ...
    def get_command(self):
        ...
        if self.left_upper_switch_pressed:
            ...
            print(f"Auto command mode: {self.auto_cmd}")
    ...
    # def _optitrack_cb(self, channel, data):
    ...
    def _imu_cb(self, channel, data):
        ...
        self.contact_state = 1.0 * (np.array(msg.contact_estimate) > 160)
        self.ori_contact_state = np.array(msg.contact_estimate)
